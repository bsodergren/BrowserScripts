...
;(function () {
  ...
  var btnContainerId = '.cmtHeader h2'
  var VideoListCmd = grabVideoList

  if(playlistId == 'watchlater'){
...
//   }
  ...
  // linkGrabberBtn.appendChild(span)
    console.log(linkGrabberBtn)

//    if(playlistId == 'favorites')
//    {
//       var child = btnContainer.querySelector('.clear')
//           console.log(child)
         linkGrabberBtn.style = '--main-font-size: 16px;font-family: Arial,Helvetica,sans-serif;color: #969696;cursor: pointer;line-height: 38px;margin: 0;padding: 0;float: left;font-weight: 700; font-size: 14px;'


//       btnContainer.insertBefore(linkGrabberBtn,child)
//    } else {
