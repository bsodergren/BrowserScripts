...
// @downloadURL https://update.sleazyfork.org/scripts/6587/ExtendPornHub.user.js
// @updateURL https://update.sleazyfork.org/scripts/6587/ExtendPornHub.meta.js
// ==/UserScript==
...
(function addStyle() {
	...
	var ephcss =
		...
		"#countryRedirectMessage {" + "display: none !important;" + "}" +
		// Pornstars page
		"ul.top_trending_pornstar {" + "display: table !important;" + "margin: auto !important;" + "}" + "ul.top_trending_pornstar li {" + "display: table-cell !important;" + "}" + ".sectionWrapper .pornstarVideosCounter {" + "width: 100% !important;" + "}" +
		// Gifs page
		".gifsWrapper ul.gifs li.first {" + "margin-right: 12px !important;" + "margin-top: 0 !important;" + "height: 353px !important;" + "margin-bottom: 12px !important;" + "}" + "@media only screen and (min-width: 1350px) {" + ".gifsWrapper ul.gifs li.first {" + "height: 381px !important;" + "}" + ".gifsWrapper ul.gifs li:nth-child(8) {" + "display: none !important;" + "}" + "}" + ".gifColumnLeft.float-left {" + "width: 100% !important;" + "}";
	// Inject created CSS
...
(function ExtendPornHub() {
	...
	function videoStuff() {
		...
		node.setAttribute("style", "position: fixed;" + "bottom: 0;" + "right: 0;" + "cursor: pointer;" + "border: 1px solid #313131;" + "border-top-left-radius: 5px;" + "color: #acacac;" + "font-weight: 700;" + "background: #2f2f2f;" + "text-align: center;" + "font-size: 12px;" + "padding: 7px 15px;" + "z-index: 999999;");
				...
				if (!!chg.target.className.match(/playerFlvContainer/)) {
					chg.addedNodes.forEach(function(element) {
						if (!!element && element.id === "pb_template") {
							...
							node.innerHTML = "<div class='mhp1138_play' style='display: block'>" + "    <div class='mhp1138_icon mhp1138_icon-play'></div>" + "</div>" + "<div class='mhp1138_background'></div>";
