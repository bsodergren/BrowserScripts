...
// @compatible         safari
// @compatible         kiwi
// @version            2025.05.2.0128
// @created            2025-03-05 01:45:13
// @modified           2025-03-05 01:45:13
// @downloadURL https://update.sleazyfork.org/scripts/563118/Pornhub%20video%20download%20with%20one%20click.user.js
// @updateURL https://update.sleazyfork.org/scripts/563118/Pornhub%20video%20download%20with%20one%20click.meta.js
// ==/UserScript==
...
GM_addStyle(`
    ...
    .download-urls ul li { display: flex; align-items: center; height: 20px; max-width:720px; }
...
(function() {
	...
	const translate = new Proxy(function(key) {
		const lang = userLang
