// ==UserScript==
// @name     nubiles playlist videos link grabber
// @description This adds a button to pornhub playlists to grab links to all videos of this playlist
// @version  1.0.1
// @license MIT
// @grant    none
// @match    https://members.nubiles-porn.com/video/*
// ==/UserScript==
(function() {
	'use strict';
	var btnContainer = document.querySelector(".content-grid-ribbon-center")
	...
	function grabVideoList() {
		var linkList = document.querySelectorAll(".img-wrapper > a")
